...
namespace XamarinAudioClient
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            //telephonyManager.Listen(ps, PhoneStateListenerFlags.SignalStrength);
        ...
        *********************************************************************************/
        ...
        void ButtonConnect_Click(object sender, EventArgs e)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("buttonConnect_Click SocketException:" + ex.ToString());
            }
            catch (AggregateException ex)
            {
                System.Diagnostics.Debug.WriteLine("buttonConnect_Click AggregateException:" + ex.ToString());
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.Write("buttonConnect_Click Exception:" + ex.ToString());
            }
        }
            ...
            audioControlThread = new Thread(() => // Thread (like Timer)
            {
                try
                {
                    while (true)
                    {
                        ...
                        {
                            System.Diagnostics.Debug.WriteLine("AudioControlTask get CancellationRequested");
                            break;
                        }
                        ...
                        if ( tcpStream.DataAvailable )
                        {
                            ...
                            if (resSize == 1)
                            {
                                ...
                                System.Diagnostics.Debug.WriteLine("TCP RX n={0} d=0x{1}\n", resSize, resBytes[0].ToString("X2"));
        ...
        void SendTcpData(Byte[] data)
        {
            ...
            try
            {
                if (tcpClient.Connected) // if the client is connected
                {
                    ...
                    System.Diagnostics.Debug.WriteLine("TCP TX n={0} d=0x{1}\n", data.Length.ToString(), data[0].ToString("X2"));
                }
            }
            catch (Exception ex)
            {
        ...
        void ButtonTx_Click(object sender, EventArgs e)
        {
                    ...
                    while (true)
                    {
                        ...
                        try
                        {
                            ...
                            if (data != null)
                            {
                                ...
                                System.Diagnostics.Debug.WriteLine("UDP TX:{0}, {1}, n={2}, d={3}, c={4}",
                                    DateTime.Now.ToString("ss.fff"),
                                    txCount++.ToString(),
                                    data.Length.ToString(),
                                    data[0].ToString(),
                                    AudioInterface.RecordBuffer.Instance.Count.ToString());
            ...
            else
            {
                ...
                AudioInterface.WaveBuffer.Instance.WriteFile();
                AudioInterface.WaveBuffer.Instance.Clear();
                ...
                audioTrackThread = new Thread(() =>
                {
                    try
                    {
                        ...
                        while (true)
                        {
                            ...
                            if (udpClient.Available >= 256)
                            {
                                IPEndPoint remoteEp = null;
                                Byte[] resBytes = udpClient.Receive(ref remoteEp);

                                System.Diagnostics.Debug.WriteLine("UDP RX:{0}, {1}, n={2}, d={3}, c={4}", 
                                    DateTime.Now.ToString("ss.fff"),
                                    rxCount++.ToString(),
                                    resBytes.Length.ToString(), 
                                    resBytes[0].ToString(), 
                                    AudioInterface.TrackBuffer.Instance.Count.ToString());
